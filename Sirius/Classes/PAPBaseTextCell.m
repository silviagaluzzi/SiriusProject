...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        if (!timeFormatter) {
            ...
            timeFormatter.pastDeicticExpression = @"";
        }
...
- (void)setUser:(SiriusUser *)aUser {
    user = aUser;
    
    // Set name button properties and avatar image
    //[self.avatarImageView setFile: self.user.profilePictureSmall];
    //[self.nameButton setTitle:[self.user displayName] forState:UIControlStateNormal];
    //[self.nameButton setTitle:[self.user displayName] forState:UIControlStateHighlighted];
