...
@property (nonatomic, strong) SiriusUser *user;
...
/*!
 ...
 @param aUser the SiriusUser of the user that was tapped
 */
- (void)cell:(PAPBaseTextCell *)cellView didTapUserButton:(SiriusUser *)aUser;
